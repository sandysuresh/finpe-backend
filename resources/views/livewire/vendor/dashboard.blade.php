                ...
                <div class="flex h-48 items-end gap-2">
                    @foreach ($chartCounts as $count)
                        ...
                        <div class="group relative flex flex-1 flex-col items-center">
                            ...
                            <div class="w-full rounded-t-lg bg-violet-700 transition-all hover:bg-violet-600" style="height:{{ $pct }}%"></div>
                        </div>
                    @endforeach
                </div>
                <div class="mt-2 flex">
                ...
                <div class="space-y-3">
                    ...
                    <div class="border-t border-slate-100 pt-3">
                        <div class="flex items-center justify-between">
                            ...
                            @php $kycCls = match($v->kyc_status) { 'verified'=>'bg-emerald-50 text-emerald-700','rejected'=>'bg-red-50 text-red-600','submitted'=>'bg-blue-50 text-blue-700',default=>'bg-amber-50 text-amber-700' }; @endphp
                            <a href="{{ route('vendor.profile') }}"
                               class="inline-flex rounded-full px-2.5 py-0.5 text-[11px] font-semibold {{ $kycCls }} hover:opacity-80">
                                {{ $v->kyc_status === 'verified' ? 'KYC Approved' : ucfirst($v->kyc_status) }}
                            </a>
                        </div>
                    </div>
                </div>
