<div>
    ...
    <div class="mb-5 grid grid-cols-2 gap-4 lg:grid-cols-5">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$l,$v,$vc,$bg,$ic]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="fi-card flex items-center gap-4 p-4">
                <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl <?php echo e($bg); ?>">
                    <span class="text-sm font-bold <?php echo e($ic); ?>"><?php echo e(number_format($v)); ?></span>
                </div>
                <div>
                    <p class="text-xs text-slate-400"><?php echo e($l); ?></p>
                    <p class="text-base font-bold <?php echo e($vc); ?>"><?php echo e(number_format($v)); ?></p>
                </div>
            </div>
        ...
        <div class="fi-card flex items-center gap-4 p-4">
            ...
            <div>
                ...
                <p class="text-base font-bold text-slate-900">₹<?php echo e($summary['volume']); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="fi-card overflow-hidden">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transactions->isEmpty()): ?>
            ...
            <div class="flex flex-col items-center justify-center px-6 py-24 text-center">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $status || $service || $dateFrom || $dateTo): ?>
                    ...
                    <div class="mt-8 grid max-w-lg grid-cols-3 gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                            ...
                            <div class="rounded-xl border border-slate-100 bg-slate-50 p-4 text-center">
                                <div class="mx-auto mb-2 flex h-7 w-7 items-center justify-center rounded-full bg-violet-600 text-xs font-bold text-white"><?php echo e($n); ?></div>
                                <p class="text-xs font-semibold text-slate-700"><?php echo e($t); ?></p>
                                <p class="mt-1 text-[11px] text-slate-400"><?php echo e($d); ?></p>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    ...
                    <tbody class="divide-y divide-slate-50">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="transition-colors hover:bg-slate-50">
                                ...
                                <td class="whitespace-nowrap px-5 py-4">
                                    <span class="inline-flex rounded-full px-2.5 py-0.5 text-[11px] font-semibold <?php echo e($sc); ?>"><?php echo e(ucfirst($tx->status)); ?></span>
                                </td>
                                <td class="whitespace-nowrap px-5 py-4 text-xs text-slate-400"><?php echo e($tx->created_at->format('d M Y, h:i A')); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </tbody>
                </table>
...
<?php /**PATH /home/sandeep/Documents/finpay/resources/views/livewire/vendor/transaction-report.blade.php ENDPATH**/ ?>