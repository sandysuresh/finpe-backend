<div>
    ...
    <div class="fi-card mb-6 overflow-hidden">
        <div class="px-6 py-5">
            <div class="flex items-center gap-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['form'=>'1. Details','confirm'=>'2. Confirm','success'=>'3. Done']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="flex items-center">
                        <span class="flex h-9 w-9 items-center justify-center rounded-full border text-sm font-semibold
                            <?php echo e($curr ? 'border-violet-600 bg-violet-600 text-white' : ($done ? 'border-green-300 bg-green-100 text-green-700' : 'border-slate-300 bg-white text-slate-400')); ?>">
                            <?php echo e($done ? '✓' : $loop->index + 1); ?>

                        </span>
                        <span class="ml-2 hidden text-sm font-medium lg:block
                            <?php echo e($curr ? 'text-violet-700' : ($done ? 'text-green-700' : 'text-slate-400')); ?>">
                            <?php echo e(explode('. ',$lbl)[1]); ?>

                        </span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$loop->last): ?><div class="mx-3 h-px w-8 bg-slate-200 lg:w-16"></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 'form'): ?>
    <div class="fi-card p-6">
        <h3 class="mb-5 text-base font-semibold text-slate-900">Transfer Details</h3>

        
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->beneficiaries->isNotEmpty()): ?>
        <div class="mb-5">
            ...
            <select wire:model.live="beneficiaryId" wire:change="fillBeneficiary" class="fi-input text-sm">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->beneficiaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($b->id); ?>"><?php echo e($b->name); ?> — <?php echo e($b->account_number); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </select>
        </div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['beneficiaryName'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$beneficiaryId): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 'confirm' && $previewData): ?>
    <div class="fi-card p-6">
            ...
            <div class="space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                    ...
                    <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                        <span class="text-sm text-slate-500"><?php echo e($l); ?></span>
                        <span class="text-sm font-semibold text-slate-800"><?php echo e($v); ?></span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="flex items-center justify-between pt-1">
                    <span class="text-base font-bold text-slate-900">Transfer Amount</span>
                    <span class="text-2xl font-bold text-violet-700">₹<?php echo e($previewData['amount']); ?></span>
                </div>
            </div>
        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 'success'): ?>
    <div class="fi-card p-12 text-center">
        ...
        <div class="mx-auto mt-4 inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2">
            ...
            <span class="font-mono text-sm font-bold text-slate-800"><?php echo e($txReference); ?></span>
        </div>
        <div class="mt-8 flex justify-center gap-3">
            <a href="<?php echo e(route('vendor.transactions')); ?>"
...
<?php /**PATH /home/sandeep/Documents/finpay/resources/views/livewire/vendor/send-money.blade.php ENDPATH**/ ?>