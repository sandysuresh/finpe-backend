        ...
        <div class="flex items-center justify-center p-6">
            <div class="w-full max-w-md">
                ...
                <div class="fi-card p-8">
                    ...
                    <form method="POST" action="<?php echo e(route('vendor.login.submit')); ?>" class="space-y-5">
                        <?php echo csrf_field(); ?>
                        <div>
                ...
                <p class="mt-6 text-center text-sm text-slate-500">
                    Admin?
                    <a href="<?php echo e(route('admin.login')); ?>" class="font-semibold text-violet-600 hover:underline">Go to Admin Panel</a>
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/sandeep/Documents/finpay/resources/views/auth/vendor-login.blade.php ENDPATH**/ ?>