                            ...
                            <tr class="transition-colors hover:bg-slate-50">
                                ...
                                <td class="whitespace-nowrap px-5 py-4">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vendor): ?>
                                        <a href="<?php echo e(route('admin.vendors.show', $vendor)); ?>" class="text-sm font-semibold text-blue-700 hover:underline">
                                            <?php echo e($vendor->business_name); ?>

                                        </a>
                                        <p class="text-xs text-slate-400"><?php echo e($vendor->vendor_code); ?></p>
                                    <?php else: ?>
                                        <p class="text-sm font-semibold text-slate-800"><?php echo e($tx->vendor_name ?? '—'); ?></p>
...
<?php /**PATH /home/sandeep/Documents/finpay/resources/views/livewire/admin/transactions.blade.php ENDPATH**/ ?>