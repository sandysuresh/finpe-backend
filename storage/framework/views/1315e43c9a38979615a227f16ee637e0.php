    ...
    <div class="mb-6 grid grid-cols-4 gap-4">
        ...
        <div class="fi-card p-5">
            ...
            <p class="mt-2 text-2xl font-bold text-amber-500">
                <?php echo e(\App\Models\Vendor::whereIn('kyc_status', ['pending', 'submitted'])->count()); ?>
                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?php echo e(route('admin.vendors.show', $vendor)); ?>" class="fi-btn fi-btn-primary fi-btn-sm">
                                        View
                                    </a>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vendor->registration_step < 7): ?>
                                        <a href="<?php echo e(route('admin.vendors.create', $vendor)); ?>" class="fi-btn fi-btn-secondary fi-btn-sm">
                                            Continue
                                        </a>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
