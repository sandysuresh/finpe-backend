<div>
    ...
    <div class="mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <div class="fi-card p-5">
            ...
            <p class="mt-3 text-3xl font-bold text-emerald-600"><?php echo e($summary['approved']); ?></p>
        ...
        <div class="fi-card p-5">
            ...
            <p class="mt-3 text-3xl font-bold text-red-500"><?php echo e($summary['rejected']); ?></p>
